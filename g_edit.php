...
<head>
    ...
    <title>แก้ไขข้อมูลรับงบประมาณ</title>
...
<body>
    ...
    if(isset($_GET['id'])){
      ...
      $stmt = $conn->prepare("SELECT* FROM g_budget WHERE id=?");
      $stmt->execute([$_GET['id']]);
      $row = $stmt->fetch(PDO::FETCH_ASSOC);
      //ถ้าคิวรี่ผิดพลาดให้กลับไปหน้า index
      if($stmt->rowCount() < 1){
          header('Location: g_budget.php');
          exit();
      }
    }//isset
    ?>
...
<!-- Navbar -->
            ...
            <center><h3>แก้ไขข้อมูลรับงบประมาณ</h3></center>
            <br><br>
  ...
  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">จำนวนเงิน</label>
         <input type="text" id="form6Example4" class="form-control" name = "bud_amount" required value="<?= $row['bud_amount'];?>"/>  
  </div>

  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">วันที่รับเงิน</label>
         <input type="text" id="form6Example4" class="form-control" name = "bud_date" required value="<?= $row['bud_date'];?>"/>   
  </div>

  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">รายละเอียด</label>
         <input type="text" id="form6Example4" class="form-control" name = "bud_details" required value="<?= $row['bud_details'];?>"/>   
  </div>
...
&nbsp;&nbsp;&nbsp; &nbsp;
<input type="reset" class="btn btn-danger" value="ยกเลิก" onclick="window.location.href='g_budget.php?val='">
