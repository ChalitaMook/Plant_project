...
<main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
            <center><h3>เพิ่มข้อมูลประเภทพันธุ์พืช</h3></center>
            <br><br>
            <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-light">
                    <form class="requires-validation" enctype="multipart/form-data" method="post" action="add_type.php" novalidate>
  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">ชื่อ</label>
         <input type="text" id="form6Example4" class="form-control" name = "type_name" />
  </div>
  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">รายละเอียด</label>
         <input type="text" id="form6Example4" class="form-control" name = "type_details" />
