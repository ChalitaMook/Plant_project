...
<a href="user_add.php" class="btn btn-info" style="float:right;">เพิ่มข้อมูล</a> </h3>
<br><br>
      <tr>
      <th scope ="col" width = "13%" >รหัสผู้ใช้งาน</th>
      <th scope ="col"width = "13%">อีเมล</th>
      <!--<th scope ="col"width = "7%">รหัสผ่าน</th>-->
      <th scope ="col"width = "12%">ชื่อ</th>
      <th scope ="col"width = "9%">นามสกุล</th>
      <th scope ="col"width = "7%">เบอร์โทร</th>
      <th scope ="col"width = "15%">ที่อยู่</th>
      <th scope ="col"width = "7%">สถานะ</th>
      <th scope ="col"width = "20%">แก้ไข</th>
      </tr>
    </thead>
    <?php
      ...
      <tr>
        ...
        <td scope ="row"><?= $k['user_email']; ?></td>
        <!--<td scope ="row"><?= $k['user_pass']; ?></td>-->
        <td scope ="row"><?= $k['user_first']; ?></td>
        <td scope ="row"><?= $k['user_last']; ?></td>
        <td scope ="row"><?= $k['user_tel']; ?></td>
        <td scope ="row"><?= $k['user_add']; ?></td>
        <td scope ="row"><?= $k['user_status']; ?></td>
        <td><a href="user_Edit.php?id=<?= $k['id'];?>" class="btn btn-warning btn-sm">แก้ไข</a> &nbsp;
        <a href="delete.php?id=<?= $k['id'];?>" class="btn btn-danger btn-sm" onclick="return confirm('ยืนยันการลบข้อมูล !!');">ลบ</a>
        </td>
  ...
  &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 
                ...
                &nbsp; &nbsp;&nbsp; &nbsp;
                <a href="system.php?id=" class="btn btn-secondary btn-sm">หน้าถัดไป</a>
                &nbsp; &nbsp;&nbsp; &nbsp;
</body>
</html>
