...
<html lang="en">
    <head>
        ...
        <title>รายงานข้อมูลบันทึกการทำงาน</title>
        <style type="text/css">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12"> <br>
                    <h4>รายงานข้อมูลบันทึกการทำงาน</h4>
                    ...
                    <br>
                    <a class="btn btn-outline-dark" href="report_t1.php" role="button">รายงาน</a>
                    ...
                    <table class="table table-striped  table-hover table-responsive table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th width="20%">งานที่มอบหมาย</th>
                                <th width="20%">รายละเอียดงาน</th>
