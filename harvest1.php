...
<br><br>
      ...
      <th scope ="col"width = "10%">พื้นที่แปลง</th>
    ...
    <?php
      ...
      <tr>
        ...
        <td scope ="row"><?= $k['id_h']; ?></td>
        <td scope ="row"><?= $k['p_id']; ?></td>
        <td scope ="row"><?= $k['p_name']; ?></td>
        <td scope ="row"><?= $k['amount_h']; ?></td>
        <td scope ="row"><?= $k['date_h']; ?></td>
        <td scope ="row"><?= $k['zone_h']; ?></td>
        </td>
  ...
  &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 
                ...
                &nbsp; &nbsp;&nbsp; &nbsp;
                <a href="grow_v1.php?id=" class="btn btn-secondary btn-sm">หน้าที่ผ่านมา</a>
                &nbsp; &nbsp;&nbsp; &nbsp;
                <a href="sell_pro1.php?id=" class="btn btn-info btn-sm">หน้าถัดไป</a>
                &nbsp; &nbsp;&nbsp; &nbsp;
</body>
</html>