...
<br><br>
      ...
      <th scope ="col" width = "12%" >รหัสเก็บเกี่ยว</th>
...
$total_sell_pro = $row['total'];
      ...
      <tr>
        ...
        <td scope ="row"><?= $k['id_s']; ?></td>
        <!--<td scope ="row"><?= $k['type_s']; ?></td>-->
        <td scope ="row"><?= $k['amount_s']; ?></td>
        <td scope ="row"><?= $k['date_s']; ?></td>
         <!--<td scope ="row"><?= $k['details_s']; ?></td>-->
        </td>
  ...
  &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 
                ...
                &nbsp; &nbsp;&nbsp; &nbsp;
                <a href="harvest1.php?id=" class="btn btn-secondary btn-sm">หน้าที่ผ่านมา</a>
                &nbsp; &nbsp;&nbsp; &nbsp;
                <a href="account.php?id=" class="btn btn-info btn-sm">หน้าถัดไป</a>
                &nbsp; &nbsp;&nbsp; &nbsp;
</body>
</html>
