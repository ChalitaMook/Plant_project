...
<a href="p_add.php" class="btn btn-info" style="float:right;">เพิ่มข้อมูล</a> </h3>
<br><br>
      <tr>
      <th scope ="col" width = "10%" >รหัสโซน</th>
      <th scope ="col"width = "15%">ชื่อโซน</th>
      <th scope ="col"width = "15%">จำนวนแปลง</th>
      <th scope ="col"width = "15%">ขนาดโซน</th>
      <th scope ="col"width = "11%">จัดการ</th>
      </tr>
    </thead>
    <?php
      ...
      <tr>
        ...
        <td scope ="row"><?= $k['area_amount']; ?></td>
        <td scope ="row"><?= $k['area_size']; ?></td>
        <td><a href="p_edit.php?area_id=<?= $k['area_id'];?>" class="btn btn-warning btn-sm">แก้ไข</a> &nbsp;
        <a href="p_del.php?area_id=<?= $k['area_id'];?>" class="btn btn-danger btn-sm" onclick="return confirm('ยืนยันการลบข้อมูล !!');">ลบ</a>
        </td>
  ...
  &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 
                ...
                <a href="assign.php?id=" class="btn btn-info btn-sm">หน้าถัดไป</a>
                &nbsp; &nbsp;&nbsp; &nbsp;
</body>
</html>
