...
<head>
    ...
    <title>แก้ไขข้อมูลเบิกพันธุ์พืช</title>
...
<body>
    ...
    if(isset($_GET['id'])){
      ...
      $stmt = $conn->prepare("SELECT* FROM d_plants WHERE id=?");
      $stmt->execute([$_GET['id']]);
      $row = $stmt->fetch(PDO::FETCH_ASSOC);
      //ถ้าคิวรี่ผิดพลาดให้กลับไปหน้า index
      if($stmt->rowCount() < 1){
          header('Location: d_plants.php');
          exit();
      }
    }//isset
    ?>
...
<!-- Navbar -->
            ...
            <center><h3>แก้ไขข้อมูลเบิกพันธุ์พืช</h3></center>
            <br><br>
    ...
    <div class="form-outline mb-4">
      ...
      <input type="text" id="typeText" class="form-control" name = "id_d" required value="<?= $row['id_d'];?>" />
      </div>
  ...
  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">จำนวนที่เบิก</label>
         <input type="text" id="form6Example4" class="form-control" name = "amount_d" required value="<?= $row['amount_d'];?>"/>   
  </div>

  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">วันที่เบิก</label>
         <input type="text" id="form6Example4" class="form-control" name = "date_d" required value="<?= $row['date_d'];?>"/>   
  </div>
