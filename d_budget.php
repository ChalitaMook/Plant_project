...
th {
    ...
    color: white;
      ...
      <tr>
      <th scope ="col" width = "20%" >รหัสเบิกงบประมาณ</th>
      ...
      <th scope ="col"width = "20%">รายละเอียดการเบิก</th>
...
$total_budget_dis = $row['total'];
      ...
      <tr>
        ...
        <td><a href="budget_dis_edit1.php?id=<?= $k['id'];?>" class="btn btn-warning btn-sm">อนุมัติ</a>
        <br><br>
        </td>
      </tr>
   <?php
  ...
  <?php
   echo "จำนวนเงินทั้งหมด: " . number_format($total_budget_dis, 2) . " บาท";
    ?>
  </ol>
                </nav>
  ...
  &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 
                ...
                &nbsp; &nbsp;&nbsp; &nbsp;
                <a href="g_budget.php?id=" class="btn btn-secondary btn-sm">หน้าที่ผ่านมา</a>
                &nbsp; &nbsp;&nbsp; &nbsp;
