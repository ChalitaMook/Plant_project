...
<head>
    ...
    <title>เพิ่มข้อมูลรับพันธุ์พืช</title>
...
<!-- Navbar -->
            ...
            <center><h3>เพิ่มข้อมูลรับพันธุ์พืช</h3></center>
            <br><br>
            <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-light">
                    <form class="requires-validation"  method="post" action="add_gp.php" novalidate>
      ...
      <input type="text" id="typeText" class="form-control" name = "id_g" />
      </div>

      <div class="form-outline mb-4">
      <label class="form-label" for="typeText">รหัสพันธุ์พืช</label>
      <input type="text" id="typeText" class="form-control" name = "p_id" />
      </div>
  ...
  <div class="form-outline mb-4">
    ...
    <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">ประเภท</label>
         <input type="text" id="form6Example4" class="form-control" name = "type_g"/>  
  </div>
     
  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">จำนวนที่รับ</label>
         <input type="text" id="form6Example4" class="form-control" name = "amount_g"/>  
  </div>

  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">จำนวนเงินที่จ่าย</label>
         <input type="text" id="form6Example4" class="form-control" name = "ng_g"/>  
  </div>

  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">วันที่ปลูก</label>
         <input type="text" id="form6Example4" class="form-control" name = "date_g"/>   
  </div>

  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">รายละเอียด</label>
         <input type="text" id="form6Example4" class="form-control" name = "details_g"/>   
  </div>
