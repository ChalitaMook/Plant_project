...
<head>
    ...
    <title>แก้ไขข้อมูลพันธุ์พืช</title>
...
<!-- Navbar -->
            ...
            <center><h3>แก้ไขข้อมูลพันธุ์พืช</h3></center>
            <br><br>
            <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-light">
                    <form class="requires-validation" enctype="multipart/form-data" method="post" action="edit_db.php" novalidate>
                    
                    <input type="hidden" name="plant_id" required value="<?= $row['plant_id'];?>" >
  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">ชื่อ</label>
         <input type="text" id="form6Example4" class="form-control" name = "plant_name" required value="<?= $row['plant_name'];?>"/>  
  </div>

  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">อายุ</label>
         <input type="text" id="form6Example4" class="form-control" name = "plant_age" required value="<?= $row['plant_age'];?>" /> 
        </div> 
  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">ประเภท</label>
        <select class="form-control" name="type_name" id="type_name">
            <option required value="<?= $row['type_name'];?>">---</option>
  ...
  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">รายละเอียด</label>
         <input type="text" id="form6Example4" class="form-control" name = "plant_details" required value="<?= $row['plant_details'];?>"/>
  </div>
  <div class="form-outline mb-4">
