...
<head>
    ...
    <title>แก้ไขข้อมูลขายผลผลิต</title>
...
<body>
    ...
    if(isset($_GET['id'])){
      ...
      $stmt = $conn->prepare("SELECT* FROM sell_pro WHERE id=?");
      $stmt->execute([$_GET['id']]);
      $row = $stmt->fetch(PDO::FETCH_ASSOC);
      //ถ้าคิวรี่ผิดพลาดให้กลับไปหน้า index
      if($stmt->rowCount() < 1){
          header('Location: sell_pro.php');
          exit();
      }
    }//isset
    ?>
...
<!-- Navbar -->
            ...
            <center><h3>แก้ไขข้อมูลการขายผลผลิต</h3></center>
            <br><br>
  ...
  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">จำนวนเงิน</label>
         <input type="text" id="form6Example4" class="form-control" name = "sell_amount" required value="<?= $row['sell_amount'];?>"/>   
  </div>

  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">วันที่ขายผลผลิต</label>
         <input type="text" id="form6Example4" class="form-control" name = "sell_date" required value="<?= $row['sell_date'];?>"/>   
  </div>

  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">รายละเอียด</label>
         <input type="text" id="form6Example4" class="form-control" name = "sell_details" required value="<?= $row['sell_details'];?>"/>   
  </div>
