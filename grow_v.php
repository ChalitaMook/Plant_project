...
<a href="grow_add.php" class="btn btn-info" style="float:right;">เพิ่มข้อมูล</a> </h3>
<br><br>
      <tr>
      ...
      <th scope ="col"width = "12%">รหัสแปลง</th>
    ...
    <?php
      ...
      <tr>
        <td scope ="row"><?= $k['grow_id']; ?></td>
        <td scope ="row"><?= $k['id']; ?></td>
        <td scope ="row"><?= $k['plant_id']; ?></td>
        <td scope ="row"><?= $k['grow_amount']; ?></td>
        <td scope ="row"><?= $k['grow_date']; ?></td>
        <td scope ="row"><?= $k['area_id']; ?></td>
        <td><a href="grow_edit.php?id=<?= $k['id'];?>" class="btn btn-warning btn-sm">แก้ไข</a> &nbsp;
        <a href="grow_del.php?id=<?= $k['id'];?>" class="btn btn-danger btn-sm" onclick="return confirm('ยืนยันการลบข้อมูล !!');">ลบ</a>
        </td>
  ...
  &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 
                ...
                &nbsp; &nbsp;&nbsp; &nbsp;
                <a href="work_s.php?id=" class="btn btn-secondary btn-sm">หน้าที่ผ่านมา</a>
                &nbsp; &nbsp;&nbsp; &nbsp;
                <a href="harvest.php?id=" class="btn btn-info btn-sm">หน้าถัดไป</a>
                &nbsp; &nbsp;&nbsp; &nbsp;
</body>
</html>
