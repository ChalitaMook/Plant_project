...
<br><br>
    ...
    <?php
      ...
      <tr>
        ...
        <td scope ="row"> <img width = "150" src="image/<?=$k['plant_pic']?>"> </td>

        <td><a href="plant_edit.php?plant_id=<?= $k['plant_id'];?>" class="btn btn-warning btn-sm">แก้ไข</a> &nbsp;
        <a href="plant_del.php?plant_id=<?= $k['plant_id'];?>" class="btn btn-danger btn-sm" onclick="return confirm('ยืนยันการลบข้อมูล !!');">ลบ</a>
  ...
  &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 
                ...
                &nbsp; &nbsp;&nbsp; &nbsp;
                <a href="p_area.php?id=" class="btn btn-info btn-sm">หน้าถัดไป</a>
                &nbsp; &nbsp;&nbsp; &nbsp;
