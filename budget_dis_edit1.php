...
<head>
    ...
    <title>อนุมัติเบิกงบประมาณ</title>
...
<!-- Navbar -->
            ...
            <h3>อนุมัติเบิกงบประมาณ</h3>
            <br><br>
            <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-light">
                    <form class="requires-validation"  method="post" action="edit_db1.php" novalidate>

  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">สถานะ</label>
         <input type="text" id="form6Example4" class="form-control" name = "dis_status" required value="<?= $row['dis_status'];?>"/>   
  </div>
