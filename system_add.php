...
<!-- Navbar -->
            ...
            <center><h3>เพิ่มข้อมูลระบบ</h3></center>
            <br><br>
            <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-light">
                    <form class="requires-validation"  enctype="multipart/form-data" method="post" action="add_sys.php" novalidate>
      <div class="form-outline mb-4">
        <label class="form-label" for="typeText">วันที่ก่อตั้ง</label>
        <input class="form-control" type="date" id="date" name="sys_date">
  </div>
    </select>
    </div>
    <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">ชื่อผู้ดูแลโครงการ</label>
         <input type="text" id="form6Example4" class="form-control" name = "sys_name" />        
  </div>

  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">เบอร์โทร</label>
         <input type="text" id="form6Example4" class="form-control" name = "sys_tel" />        
  </div>
  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">ที่ตั้งโครงการ</label>
         <input type="text" id="form6Example4" class="form-control" name = "sys_add" />        
  </div>
  <div class="form-outline mb-4">
