...
<head>
    ...
    <title>เพิ่มข้อมูลเบิกพันธุ์พืช</title>
...
<!-- Navbar -->
            ...
            <center><h3>เพิ่มข้อมูลเบิกพันธุ์พืช</h3></center>
            <br><br>
            <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-light">
                    <form class="requires-validation"  method="post" action="add_gd.php" novalidate>
                    <div class="form-outline">
      <label class="form-label" for="typeText">รหัสเบิกพันธุ์พืช</label>
      <input type="text" id="typeText" class="form-control" name = "id" /> 
      </div>
      <br>
      <div class="form-outline mb-4">
      <label class="form-label" for="typeText">รหัสผู้ใช้งาน</label>
      <input type="text" id="typeText" class="form-control" name = "id_d" />
      </div>
  ...
  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">จำนวนที่เบิก</label>
         <input type="text" id="form6Example4" class="form-control" name = "amount_d"/>  
  </div>

  <div class="form-outline mb-4">
        <label class="form-label" for="form6Example4">วันที่เบิก</label>
         <input type="text" id="form6Example4" class="form-control" name = "date_d"/>   
  </div>
